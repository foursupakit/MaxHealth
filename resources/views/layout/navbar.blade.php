<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            <img class="navbar-brand-logo" src="{{asset('assets/images/logo.png')}}" title="Max Health">
            <span class="navbar-brand-text hidden-xs-down"> Max Health</span>
        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="javascript:void(0)" title="Messages"
                       aria-expanded="false" data-animation="scale-up" role="button">
                        <i class="icon md-money-box" aria-hidden="true"></i>&emsp;0
                    </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
                        <div class="dropdown-menu-header">
                            <h5>แจ้งเตือน</h5>
                            <span class="badge badge-round badge-danger">ใหม่ 5</span>
                        </div>
                            ...
                            <div data-role="container">
                                <div data-role="content">
                                    ...
                                    <a class="list-group-item dropdown-item" href="javascript:void(0)" role="menuitem">
                                        <div class="media">
                                            <div class="pr-10">
                                                <i class="icon md-calendar bg-blue-900 white icon-circle" aria-hidden="true"></i>
                                            </div>
                                            <div class="media-body">
