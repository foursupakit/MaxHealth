                        ...
                        <div class="panel-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="list" value="DN-202103001"
                                               autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="panel-body">
                            <form>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group input-group-icon">
                                            <input type="text" class="form-control" name="company" placeholder="พิมพ์ ชื่อ,รหัส" value="บริษัท ABC จำกัด"
                                                   autocomplete="off" />
                                            <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="phone" value="034567890"
                                               autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" autocomplete="off" value="P0001-2"/>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" autocomplete="off" value="เสื้อ"/>
                                                </td>
                                                <td>
                                                ...
                                                <td>300.00<i class="icon md-close ml-10" aria-hidden="true"></i></td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        <form>
                            ...
                            <div class="panel-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" autocomplete="off" value="บริษัท ABC จำกัด" />
                                        <span class="panel-desc">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" autocomplete="off" value="034567890" />
                                    </div>
                                </div>
                                <div class="form-group row">
